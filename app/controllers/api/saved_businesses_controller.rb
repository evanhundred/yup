...
module Api
  # saved businesses
  class SavedBusinessesController < ApplicationController
    wrap_parameters include: SavedBusiness.attribute_names + %w[saver_id business_id]
