@businesses.each do |business|
    json.set! business.id do
        json.extract! business, :id, :name, :latitude, :longitude, :address, :city, :state, :zipcode, :phone, :website, :open_at, :closed_at, :about, :category, :price, :neighborhood, :place_id, :country, :country_code
