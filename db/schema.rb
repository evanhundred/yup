...
ActiveRecord::Schema[7.0].define(version: 20_231_025_001_248) do
  ...
  create_table 'owned_businesses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[owned_business_id owner_id], name: 'index_owned_businesses_on_owned_business_id_and_owner_id'
  ...
  create_table 'saved_businesses', force: :cascade do |t|
    ...
    t.index %w[saver_id saved_business_id], name: 'index_saved_businesses_on_saver_id_and_saved_business_id'
