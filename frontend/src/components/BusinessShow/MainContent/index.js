...
const MainContent = ({ business = null, currentUser = null, props, handleWriteReview }) => {
  ...
  //         <h2>This is a stub. {currentUserIsOwner && <span className='grey'> Complete and submit the details to create a full business listing.</span>}</h2>
  //       </div>
  //     </div>
  //   );
  // };
  ...
  return (
    <>
      <div className='main-content-container'>
        ...
        <ContentNavBar business={business} currentUser={currentUser} handleWriteReview={handleWriteReview} />
        ...
        {/* recommended reviews */}
        <Reviews business={business} props={props} handleWriteReview={handleWriteReview} currentUser={currentUser} />
